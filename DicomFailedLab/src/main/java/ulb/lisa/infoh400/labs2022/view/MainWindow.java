...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void itemsListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_itemsListMouseClicked
        if (selectedList.equalsIgnoreCase("Image") && evt.getClickCount()== 2){
            System.out.println("DOUBLE CLICK");
            EntityListModel<ulb.lisa.infoh400.labs2022.model.Image>model = (EntityListModel) itemsList.getModel();
            ulb.lisa.infoh400.labs2022.model.Image selected = model.getList().get(itemsList.getSelectedIndex());
